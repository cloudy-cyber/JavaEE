        ...
        <span class="fr">
            <%
                ...
                if (obj == null) {
                    ...
                    if (flag == false) {
                        out.println("<span class=\"fl\">你好，请<a href=\"login.do\">登录</a>&nbsp; <a href=\"regist.html\" style=\"color:#ff4e00;\">免费注册</a>");
                    }
                }
                else{
                    User user = (User)obj;
        ...
        <div class="l_list">
            ...
            <div class="list_c">
                ...
                <ul class="cate_list">
                    ...
                    %>
                    <li>
                        <div class="img"><a href="detail.do?id=<%=product.getId()%>"><img src="images/per_1.jpg"
